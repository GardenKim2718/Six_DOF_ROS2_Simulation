...
# terminator -e "bash -c 'source ~/.bashrc; source install/setup.bash; ros2 topic echo /state2d; echo \"Press Enter to close the terminal...\"; read'" &
# terminator -e "bash -c 'source ~/.bashrc; source install/setup.bash; ros2 topic echo /command2d; echo \"Press Enter to close the terminal...\"; read'" &